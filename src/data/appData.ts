export default [
	...
	},
	{
		...
		help:
			"番号请使用md开头，例：md425（《某科学的超电磁炮》）；视频请使用av开头，例：av32211954。点击图片地址可以复制",
		channel: 4,
	},
	{
		name: "pornhub风格图片生成",
	...
	},
	{
		...
		help:
			"使用“${}”代表关键字，如“${5}表示首项为5的关键字。暂时只支持统一的公差/公比（其实是因为懒）",
		channel: 4,
	},
	{
		name: "文件树生成",
	...
	},
	{
		...
		icon_color: "teal-500",
		help:
			"不支持部分Html属性，请手动改为小驼峰命名法，所有操作均在本地执行，不消耗数据流量",
		channel: 3,
	},
	{
		name: "mimetype查询",
	...
	},
	{
		...
		help:
			"图片过大可能会卡顿；拉动阴影部分可调整拼接范围，适合字幕或长图拼接",
		channel: 2,
	},
	{
		name: "化学方程式配平",
